        ...
        <Flex alignItems="center">
          ...
          <Modal isOpen={!isOpen}>
            <Button variant="invisible" onClick={() => setIsOpen(true)}>
              <Flex alignItems="center">
                <Box width="18px" height="16px" marginRight="4px">
          ...
          <Modal isOpen={isOpen}>
            <Button variant="invisible" onClick={() => setIsOpen(false)}>
              <Flex alignItems="center">
                <Box width="18px" height="16px" marginRight="4px">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 12.74"><title>guide</title><path d="M13,.5H2A1.5,1.5,0,0,0,.5,2V9.5A1.5,1.5,0,0,0,2,11H8.94l2.23,2.06a.7.7,0,0,0,1.17-.52V11H13a1.5,1.5,0,0,0,1.5-1.5V2A1.5,1.5,0,0,0,13,.5ZM13,10H11.34v1.86L9.47,10.13,9.33,10H2a.5.5,0,0,1-.5-.5V2A.5.5,0,0,1,2,1.5H13a.5.5,0,0,1,.5.5V9.5A.5.5,0,0,1,13,10Z" transform="translate(-0.5 -0.5)" fill="#204ef0"/><path d="M8.88,3.75H2.94a.5.5,0,1,1,0-1H8.88a.5.5,0,0,1,0,1Z" transform="translate(-0.5 -0.5)" fill="#204ef0"/><path d="M8.88,5.88H2.94a.5.5,0,0,1-.5-.5.5.5,0,0,1,.5-.5H8.88a.5.5,0,0,1,.5.5A.51.51,0,0,1,8.88,5.88Z" transform="translate(-0.5 -0.5)" fill="#204ef0"/></svg>
                </Box>
